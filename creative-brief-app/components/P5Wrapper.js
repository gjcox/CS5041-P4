...
export default function (id = 'SketchWrapper') {
    ...
    function P5Wrapper({
        sketch = () => { },
        state = {},
        dispatch = (state, payload) => { return { ...state, [payload.key]: payload.value } }, // I have made this based on https://github.com/atorov/react-hooks-p5js/blob/master/src/components/App/AppStateProvider/reducer.js
    }) {
